...
[<assembly: AssemblyTitleAttribute("DirectoryDifference.Tests")>]
[<assembly: AssemblyProductAttribute("DirectoryDifference")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "DirectoryDifference.Tests"
    let [<Literal>] AssemblyProduct = "DirectoryDifference"
